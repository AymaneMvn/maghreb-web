        ...
        <div className="row">
          ...
          <div className="col-lg-7">
            <div className="tp-service-sa-title-wrap mb-30">
              <h3 className="fs-50 fs-lg-40 fs-xs-30 lh-120-per tp_text_invert invert-black-2">From branding to funding, we provide the tools & strategies startups need to succeed in a competitive market.</h3>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="pt-20 pb-50 tp_fade_anim" data-delay=".3">
                <h5 className="fs-25 fw-500">We helped Caleric raise $2M in funding &<br /> scale to 50K+ users.</h5>
              </div>
            </div>
            <div className="col-12">
              <div className="swiper tp-service-sa-slider p-relative">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="tp-service-sa-item tpshake-wrap tp-bg-common-white-2 mb-30">
                      ...
                      <h4 className="tp-service-sa-item-title mb-20"><a href="#">Branding Design</a></h4>
                      <p className="tp-service-sa-item-text mb-130">Branding is more than just a logo—it’s 
                        the foundation of your startup’s identity, credibility, and growth</p>
                      <span className="tp-service-sa-border mb-10 d-inline-block">
                        <svg height="6" viewBox="0 0 354 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM349 3.5L354 5.88675V0.113249L349 2.5V3.5ZM4.5 3.5H349.5V2.5H4.5V3.5Z" fill="#030303" fillOpacity="0.1" />
                        </svg>
                      </span>
                      <a href="#" className="tp-left-right fw-500 fs-15 text-uppercase tp-text-common-black">
                  ...
                  <div className="swiper-slide">
                    <div className="tp-service-sa-item tpshake-wrap tp-bg-common-white-2 mb-30">
                      ...
                      <h4 className="tp-service-sa-item-title mb-20"><a href="#">UI/UX Design</a></h4>
                      <p className="tp-service-sa-item-text mb-130">Branding is more than just a logo—it’s 
                        the foundation of your startup’s identity, credibility, and growth</p>
                      <span className="tp-service-sa-border mb-10 d-inline-block">
                        <svg height="6" viewBox="0 0 354 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="swiper-slide">
                    <div className="tp-service-sa-item tpshake-wrap tp-bg-common-white-2 mb-30">
                      ...
                      <h4 className="tp-service-sa-item-title mb-20"><a href="#">Web Development</a></h4>
                      <p className="tp-service-sa-item-text mb-130">Branding is more than just a logo—it’s 
                        the foundation of your startup’s identity, credibility, and growth</p>
                      <span className="tp-service-sa-border mb-10 d-inline-block">
                        <svg height="6" viewBox="0 0 354 6" fill="none" xmlns="http://www.w3.org/2000/svg">
